!function (e) {
  ...
  t.UPLOADSTATE = {
    ...
    COMPLETE: "complete",
    INTERRUPT: "interrupt"
  }, t.UPLOADSTEP = {INIT: "init", PART: "part", COMPLETE: "complete"}, t.UPLOADDEFAULT = {
    PARALLEL: 5,
    PARTSIZE: 1048576
  }
}, function (e, t, n) {
  ...
  var i = function () {
    ...
    return i(e, null, [{
      key: "detectIEVersion", value: function () {
        for (var e = 4, t = document.createElement("div"), n = t.getElementsByTagName("i"); t.innerHTML = "\x3c!--[if gt IE " + e + "]><i></i><![endif]--\x3e", n[0];) e++;
        return e > 4 && e
      }
    }, {
      ...
      key: "getFileType", value: function (e) {
        return e = e.toLowerCase(), /.mp4|.flv|.m3u8|.avi|.rm|.rmvb|.mpeg|.mpg|.mov|.wmv|.3gp|.asf|.dat|.dv|.f4v|.gif|.m2t|.m4v|.mj2|.mjpeg|.mpe|.mts|.ogg|.qt|.swf|.ts|.vob|.wmv|.webm/.test(e) ? "video" : /.mp3|.wav|.ape|.cda|.au|.midi|.mac|.aac|.ac3|.acm|.amr|.caf|.flac|.m4a|.ra|.wma/.test(e) ? "audio" : /.bmp|.jpg|.jpeg|.png/.test(e) ? "img" : "other"
      }
    }, {
  ...
  var i = function () {
    ...
    return i(e, null, [{
      key: "create", value: function (e, t) {
        var n, r = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split(""), i = [];
        if (t = t || r.length, e) for (n = 0; n < e; n++) i[n] = r[0 | Math.random() * t]; else {
          var o;
          for (i[8] = i[13] = i[18] = i[23] = "-", i[14] = "4", n = 0; n < 36; n++) i[n] || (o = 0 | 16 * Math.random(), i[n] = r[19 == n ? 3 & o | 8 : o])
        }
        return i.join("")
      }
    }]), e
  ...
  "use strict";
  var r, i, o = ("function" == typeof Symbol && Symbol.iterator, n(6)), a = function (e) {
    return e && e.__esModule ? e : {default: e}
  }(o), s = {Vod: a.default};
  r = [], void 0 !== (i = function () {
    return s
  }.apply(t, r)) && (e.exports = i), window.AliyunUpload = s
}, function (e, t, n) {
  "use strict";
  ...
  var o = function () {
    ...
    }(), a = n(7), s = n(1), u = n(8), c = r(u), f = n(10), l = r(f), h = n(16), d = r(h), p = n(17), g = r(p), y = n(2),
    v = r(y), _ = n(3), m = r(_), w = n(21), T = r(w), A = function () {
      function e(t) {
        i(this, e), this.options = t, this.options.partSize = this.options.partSize || s.UPLOADDEFAULT.PARTSIZE, this.options.parallel = this.options.parallel || s.UPLOADDEFAULT.PARALLEL, this._ossCreditor = new Object, this._state = a.VODSTATE.INIT, this._uploadList = [], this._curIndex = -1, this._ossUpload = null, this._log = new g.default, this._retryCount = 0, this._retryTotal = this.options.retryCount || 3, this._retryDuration = this.options.retryDuration || 2, this._state = a.VODSTATE.INIT, this._uploadWay = "vod", this._initEvent()
      }

      return o(e, [{
        key: "init", value: function (e, t, n, r) {
          return this._retryCount = 0, !(n && !r || !n && r) && (!(e && !t || !e && t) && (this._ossCreditor.accessKeyId = e, this._ossCreditor.accessKeySecret = t, this._ossCreditor.securityToken = n, this._ossCreditor.expireTime = r, !0))
        }
      }, {
        key: "addFile", value: function (e, t, n, r, i) {
          console.log(i);
          if (!e) return !1;
          if (0 == e.size) try {
          ...
          var s = new Object;
          return s.file = e, s._endpoint = t, s._bucket = n, s._object = r, s.state = a.UPLOADSTATE.INIT, s.isImage = v.default.isImage(e.name), i && (s.videoInfo = i ? JSON.parse(i).Vod : {}, s.userData = l.default.encode(i)), s.ri = m.default.create(), this._uploadList.push(s), this._reportLog("20001", s, {ql: this._uploadList.length}), !0
        }
      }, {
        key: "deleteFile", value: function (e) {
          return !!this.cancelFile(e) && (this._uploadList.splice(e, 1), !0)
        }
      }, {
        key: "cleanList", value: function () {
          this.stopUpload(), this._uploadList.length = 0
        }
      }, {
        key: "cancelFile", value: function (e) {
          this.options;
          ...
          if (e == this._curIndex && t.state == a.UPLOADSTATE.UPLOADING) {
            ...
            n && n.checkpoint && (n = n.checkpoint), n && this._ossUpload.abort(t), this._removeCheckoutpoint(t), this.nextUpload()
          } else t.state != a.UPLOADSTATE.SUCCESS && (t.state = a.UPLOADSTATE.CANCELED);
          return this._reportLog("20008", t), !0
        }
      }, {
        key: "resumeFile", value: function (e) {
          this.options;
          if (e < 0 || e >= this._uploadList.length) return !1;
          var t = this._uploadList[e];
        ...
        key: "startUpload", value: function (e) {
          this._retryCount = 0;
          this.options;
        ...
        key: "clear", value: function (e) {
          for (var t = this.options, n = 0, r = 0; r < this._uploadList.length; r++) t.uploadList[r].state == a.UPLOADSTATE.SUCCESS && n++, this._uploadList[r].state == e && (t.uploadList.splice(r, 1), r--);
        ...
        key: "stopUpload", value: function () {
          if ((this._state == a.VODSTATE.START || this._state == a.VODSTATE.FAILURE || -1 == this._curIndex) && -1 != this._curIndex) {
            ...
            this._state = a.VODSTATE.STOP, e.state = a.UPLOADSTATE.STOPED, this._changeState(e, a.UPLOADSTATE.STOPED), this._ossUpload.cancel()
          }
        }
      }, {
        key: "resumeUploadWithAuth", value: function (e) {
          var t = this;
          if (!e) return !1;
          var n = JSON.parse(l.default.decode(e));
          return !!(n.AccessKeyId && n.AccessKeySecret && n.SecurityToken && n.Expiration) && t.resumeUploadWithToken(n.AccessKeyId, n.AccessKeySecret, n.SecurityToken, n.Expiration)
        }
      }, {
        key: "resumeUploadWithToken", value: function (e, t, n, r) {
          this.options;
          if (!(e && t && n && r)) return !1;
          if (this._state != a.VODSTATE.EXPIRE) return !1;
          if (-1 == this._curIndex) return !1;
          var i = "";
          return this._uploadList.length > this._curIndex && (i = this._uploadList[this._curIndex]), i && (this.init(e, t, n, r), this._ossUpload = null, this._uploadCore(i, i.retry), i.retry = !1), !0
        }
      }, {
        key: "resumeUploadWithSTSToken", value: function (e, t, n) {
          if (-1 == this._curIndex) return !1;
          if (this._state != a.VODSTATE.EXPIRE) return !1;
        ...
        key: "setSTSTokenDirectlyUpload", value: function (e, t, n, r, i) {
          if (!(t && n && r && i)) return console.log("accessKeyId、ccessKeySecret、securityToken and expiration should not be empty."), !1;
          this._ut = "oss";
          var o = e;
          this.init(t, n, r, i), o.endpoint = o._endpoint, o.bucket = o._bucket, o.object = o._object, this._ossUpload = null, this._uploadCore(o, e.retry), e.retry = !1
        }
      }, {
        key: "setSTSToken", value: function (e, t, n, r) {
          ...
          i.ImageType && (o.imageType = i.ImageType), i.ImageExt && (o.imageExt = i.ImageExt), i.FileSize && (o.fileSize = i.FileSize), i.Description && (o.description = i.Description), i.CateId && (o.cateId = i.CateId), i.Tags && (o.tags = i.Tags), i.TemplateGroupId && (o.templateGroupId = i.TemplateGroupId);
          var a = this, s = "getUploadAuth";
          e.videoId ? (o.videoId = e.videoId, s = "refreshUploadAuth") : e.isImage && (s = "getImageUploadAuth"), T.default[s](o, function (t) {
            e.videoId = t.VideoId ? t.VideoId : e.videoId, a.setUploadAuthAndAddress(e, t.UploadAuth, t.UploadAddress)
          }, function (t) {
            a._error(e, {name: t.Code, code: t.Code, message: t.Message, requestId: t.RequestId})
          })
        }
      }, {
        key: "setUploadAuthAndAddress", value: function (e, t, n, r) {
          if (!e || !t || !n) return !1;
          var i = JSON.parse(l.default.decode(t));
          if (!(i.AccessKeyId && i.AccessKeySecret && i.SecurityToken && i.Expiration)) return console.error("uploadauth is invalid"), !1;
          var o = {};
          if (n) {
            if (o = JSON.parse(l.default.decode(n)), !o.Endpoint || !o.Bucket || !o.FileName) return console.error("uploadAddress is invalid"), !1
          } else o.Endpoint = a.endpoint, o.Bucket = a.bucket, o.FileName = a.object;
          this._ut = "vod", this._uploadWay = "vod";
          var a = e;
          this.init(i.AccessKeyId, i.AccessKeySecret, i.SecurityToken, i.Expiration), a.endpoint = a._endpoint ? a._endpoint : o.Endpoint, a.bucket = a._bucket ? a._bucket : o.Bucket, a.object = a._object ? a._object : o.FileName, r && (a.videoId = r), this._ossUpload = null, this._uploadCore(a, e.retry), e.retry = !1
        }
      }, {
        key: "_refreshSTSTokenUpload", value: function (e, t, n, r) {
          if (!t || !n || !r) return console.log("accessKeyId、ccessKeySecret、securityToken should not be empty."), !1;
          var i = {accessKeyId: t, securityToken: r, accessKeySecret: n, videoId: e.object, requestId: e.ri}, o = this,
            a = "refreshUploadAuth";
          e.isImage && (a = "getImageUploadAuth"), T.default[a](i, function (t) {
            o.setUploadAuthAndAddress(e, t.UploadAuth, UploadAddress)
          }, function (t) {
            o._error(e, {name: t.Code, code: t.Code, message: t.Message, requestId: t.RequestId})
          })
        }
      }, {
        key: "_upload", value: function (e) {
          var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = this.options;
          if (e.retry = t, n.onUploadstarted && !t) try {
        ...
        key: "_uploadCore", value: function (e) {
          ...
          console.log(e);
          var n = v.default.getFileType(e.file.name), r = this._getCheckoutpoint(e), i = "", o = "";
          r && r.checkpoint && (o = r.state, i = r.videoId, r = r.checkpoint), r && i == e.videoId && o != a.UPLOADSTATE.UPLOADING && (r.file = e.file, e.checkpoint = r, r.uploadId);
          ...
          var u = {headers: {"x-oss-notification": e.userData ? e.userData : ""}, partSize: s};
          this._ossUpload.upload(e, u)
        }
      }, {
        key: "_findUploadIndex", value: function () {
          for (var e = -1, t = 0; t < this._uploadList.length; t++) if (this._uploadList[t].state == a.UPLOADSTATE.INIT) {
            e = t;
            break
          }
          return e
          ...
          if ("cancel" == t.name) try {
            ...
            if (("RequestTimeoutError" == t.name || "ConnectionTimeout" == t.name || "ConnectionTimeoutError" == t.name) && this._retryTotal > this._retryCount) {
              ...
              return setTimeout(function () {
                n._upload(e, !0)
              }, 1e3 * this._retryDuration), void this._retryCount++
            }
            "NoSuchUploadError" == t.name && this._removeCheckoutpoint(e), this._handleError(e, t)
          }
        }
      }, {
        key: "_handleError", value: function (e, t) {
          var n = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2], r = a.UPLOADSTATE.FAIlURE;
          ...
          if (n && this._changeState(e, r), this._reportLog("20006", e, {
              code: t.name,
              message: t.message,
              ...
              ok: e.object,
              fn: e.file.name
            }), e.ri = m.default.create(), -1 != this._findUploadIndex()) {
            var i = this;
            this._state = a.VODSTATE.START, setTimeout(function () {
              i.nextUpload()
            }, 100)
          }
        }
      }, {
        key: "_complete", value: function (e, t) {
          ...
          setTimeout(function () {
            r.nextUpload()
          }, 100), this._retryCount = 0, this._reportLog("20003", e, {requestId: n})
        }
      }, {
        key: "_progress", value: function (e, t, n) {
          if (this.options.onUploadProgress) try {
            this.options.onUploadProgress(e, t.total, t.loaded)
          } catch (e) {
            console.log(e)
          }
          var r = t.checkpoint, i = 0;
          r && (e.checkpoint = r, this._saveCheckoutpoint(e, r, a.UPLOADSTATE.UPLOADING), i = r.uploadId), this._retryCount = 0;
          var o = this._getPortNumber(r), s = 0;
          n && n.headers && (s = n.headers["x-oss-request-id"]), 0 != t.loaded && this._reportLog("20007", e, {
            pn: o,
            requestId: s
        ...
        key: "_getPortNumber", value: function (e) {
          if (e) {
            var t = e.doneParts;
        ...
        key: "_removeCheckoutpoint", value: function (e) {
          var t = this._getCheckoutpointKey(e);
          d.default.remove(t)
        }
      }, {
        key: "_getCheckoutpoint", value: function (e) {
          var t = this._getCheckoutpointKey(e), n = d.default.get(t);
          if (n) try {
            return JSON.parse(n)
          } catch (e) {
          }
        ...
        key: "_saveCheckoutpoint", value: function (e, t, n) {
          if (t) {
            var r = this._getCheckoutpointKey(e), i = e.file, o = {
              fileName: i.name,
            ...
            d.default.set(r, JSON.stringify(o))
          }
        }
      }, {
        key: "_changeState", value: function (e, t) {
          var n = this._getCheckoutpoint(e);
          n && this._saveCheckoutpoint(e, n.checkpoint, t)
        }
      }, {
        key: "_getCheckoutpointKey", value: function (e) {
          return "upload_" + e.file.lastModified + "_" + e.file.name + "_" + e.file.size
        }
      }, {
        key: "_reportLog", value: function (e, t, n) {
        ...
        key: "_adjustPartSize", value: function (e) {
  ...
  var o = function () {
  ...
  }(), a = n(1), s = n(9), u = (r(s), n(2)), c = (r(u), function () {
    function e(t, n) {
      if (i(this, e), t) {
        this._config = t, this.create(this._config), this._uploadInfo = null, this._callback = {};
        var r = function () {
        };
        this._callback.onerror = n.onerror || r, this._callback.oncomplete = n.oncomplete || r, this._callback.onprogress = n.onprogress || r
      }
    }
    ...
    return o(e, [{
      ...
      key: "upload", value: function (e, t) {
        ...
        t.headers && (i.headers = t.headers), e.checkpoint && (i.checkpoint = e.checkpoint), e.bucket || (this.oss.options.bucket = e.bucket), e.endpoint || (this.oss.options.endpoint = e.endpoint), this.oss.multipartUpload(e.object, e.file, i).then(function (e, t) {
          n._complete(e)
        }).catch(function (e) {
      ...
      key: "header", value: function (e, t, n) {
      ...
      key: "_complete", value: function (e) {
  ...
  (function (e) {
    ...
    function c(e, t) {
      if (s(t), e = i(e, t < 0 ? 0 : 0 | p(t)), !o.TYPED_ARRAY_SUPPORT) for (var n = 0; n < t; ++n) e[n] = 0;
      return e
    }
    ...
    function h(e, t, n, r) {
      ...
      return t = void 0 === n && void 0 === r ? new Uint8Array(t) : void 0 === r ? new Uint8Array(t, n) : new Uint8Array(t, n, r), o.TYPED_ARRAY_SUPPORT ? (e = t, e.__proto__ = o.prototype) : e = l(e, t), e
    }
    ...
    function w(e, t, n, r, i) {
      ...
      if (i) {
        var f = -1;
        for (c = n; c < s; c++) if (o(e, c) === o(t, -1 === f ? 0 : c - f)) {
          if (-1 === f && (f = c), c - f + 1 === u) return f * a
        } else -1 !== f && (c -= c - f), f = -1
      } else for (n + u > s && (n = s - u), c = n; c >= 0; c--) {
        for (var l = !0, h = 0; h < u; h++) if (o(e, c + h) !== o(t, h)) {
          l = !1;
          break
        }
        if (l) return c
        ...
        if (i + s <= n) {
          ...
          switch (s) {
            case 1:
              ...
              break;
            case 2:
              u = e[i + 1], 128 == (192 & u) && (l = (31 & o) << 6 | 63 & u) > 127 && (a = l);
              break;
            case 3:
              u = e[i + 1], c = e[i + 2], 128 == (192 & u) && 128 == (192 & c) && (l = (15 & o) << 12 | (63 & u) << 6 | 63 & c) > 2047 && (l < 55296 || l > 57343) && (a = l);
              break;
            case 4:
 ...
 */
    ...
    t.Buffer = o, t.SlowBuffer = g, t.INSPECT_MAX_BYTES = 50, o.TYPED_ARRAY_SUPPORT = void 0 !== e.TYPED_ARRAY_SUPPORT ? e.TYPED_ARRAY_SUPPORT : function () {
      ...
      for (var a = i - r, s = n - t, u = Math.min(a, s), c = this.slice(r, i), f = e.slice(t, n), l = 0; l < u; ++l) if (c[l] !== f[l]) {
        a = c[l], s = f[l];
        break
      }
    ...
    o.prototype.slice = function (e, t) {
      ...
      return e = +e, t |= 0, n || D(this, e, t, 2, 65535, 0), o.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : B(this, e, t, !0), t + 2
    }, o.prototype.writeUInt16BE = function (e, t, n) {
      return e = +e, t |= 0, n || D(this, e, t, 2, 65535, 0), o.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : B(this, e, t, !1), t + 2
    }, o.prototype.writeUInt32LE = function (e, t, n) {
      return e = +e, t |= 0, n || D(this, e, t, 4, 4294967295, 0), o.TYPED_ARRAY_SUPPORT ? (this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = 255 & e) : M(this, e, t, !0), t + 4
    }, o.prototype.writeUInt32BE = function (e, t, n) {
      return e = +e, t |= 0, n || D(this, e, t, 4, 4294967295, 0), o.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : M(this, e, t, !1), t + 4
      ...
      return e = +e, t |= 0, n || D(this, e, t, 2, 32767, -32768), o.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : B(this, e, t, !0), t + 2
    }, o.prototype.writeInt16BE = function (e, t, n) {
      return e = +e, t |= 0, n || D(this, e, t, 2, 32767, -32768), o.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : B(this, e, t, !1), t + 2
    }, o.prototype.writeInt32LE = function (e, t, n) {
      return e = +e, t |= 0, n || D(this, e, t, 4, 2147483647, -2147483648), o.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24) : M(this, e, t, !0), t + 4
    }, o.prototype.writeInt32BE = function (e, t, n) {
      return e = +e, t |= 0, n || D(this, e, t, 4, 2147483647, -2147483648), e < 0 && (e = 4294967295 + e + 1), o.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : M(this, e, t, !1), t + 4
      ...
      if ("number" == typeof e) for (a = t; a < n; ++a) this[a] = e; else {
        var s = o.isBuffer(e) ? e : V(new o(e, r).toString()), u = s.length;
  ...
  function o(e) {
    ...
    o = r(e), a = new l(3 * s / 4 - o), n = o > 0 ? s - 4 : s;
    var u = 0;
    for (t = 0; t < n; t += 4) i = f[e.charCodeAt(t)] << 18 | f[e.charCodeAt(t + 1)] << 12 | f[e.charCodeAt(t + 2)] << 6 | f[e.charCodeAt(t + 3)], a[u++] = i >> 16 & 255, a[u++] = i >> 8 & 255, a[u++] = 255 & i;
  ...
  function u(e) {
    for (var t, n = e.length, r = n % 3, i = "", o = [], a = 0, u = n - r; a < u; a += 16383) o.push(s(e, a, a + 16383 > u ? u : a + 16383));
  ...
  for (var c = [], f = [], l = "undefined" != typeof Uint8Array ? Uint8Array : Array, h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", d = 0, p = h.length; d < p; ++d) c[d] = h[d], f[h.charCodeAt(d)] = d;
  f["-".charCodeAt(0)] = 62, f["_".charCodeAt(0)] = 63
}, function (e, t) {
  t.read = function (e, t, n, r, i) {
    var o, a, s = 8 * i - r - 1, u = (1 << s) - 1, c = u >> 1, f = -7, l = n ? i - 1 : 0, h = n ? -1 : 1, d = e[t + l];
  ...
  var o = function () {
  ...
  }(), a = n(3), s = r(a), u = n(18), c = r(u), f = n(19), l = r(f), h = n(20), d = r(h), p = function () {
    function e(t) {
      i(this, e);
      var n = d.default.os.name, r = d.default.os.version || "", o = d.default.browser.name,
        a = d.default.browser.version || "", u = window.location.href, c = "";
      u && (c = d.default.getHost(u));
      var f = "pc";
      d.default.os.ipad ? f = "pad" : (d.default.os.iphone || d.default.os.android) && (f = "phone"), this._ri = s.default.create(), this.initParam = {
        APIVersion: "0.6.0",
        lv: "1",
    ...
    return o(e, [{
      key: "log", value: function (e, t) {
        t && t.ri ? (this._ri = t.ri, delete t.ri) : this._ri = s.default.create(), t && t.ut && (this.initParam.ut = t.ut, delete t.ut), this.initParam.t = (new Date).getTime(), this.initParam.ll = "20006" == e ? "error" : "info", this.initParam.ri = this._ri, this.initParam.e = e;
        var n = [];
        if (t) for (var r in t) n.push(r + "=" + t[r]);
        var i = n.join("&");
        this.initParam.args = encodeURIComponent("" == i ? "0" : i);
        var o = [];
        for (var r in this.initParam) o.push(r + "=" + this.initParam[r]);
        var a = o.join("&");
        if (AliyunUpload && AliyunUpload.__logTestCallback__) AliyunUpload.__logTestCallback__(a); else {
  ...
  var i = function () {
    ...
    var t = navigator.userAgent, n = "other";
    if (e.ios) return "iOS";
    ...
    return i && (n = "macOS"), "X11" == navigator.platform && !r && !i && (n = "Unix"), String(navigator.platform).indexOf("Linux") > -1 && (n = "Linux"), r ? "windows" : n
  }, a = function () {
    var e = navigator.userAgent, t = "";
    return (e.indexOf("Windows NT 5.0") > -1 || e.indexOf("Windows 2000") > -1) && (t = "2000"), (e.indexOf("Windows NT 5.1") > -1 || e.indexOf("Windows XP") > -1) && (t = "XP"), (e.indexOf("Windows NT 5.2") > -1 || e.indexOf("Windows 2003") > -1) && (t = "2003"), (e.indexOf("Windows NT 6.0") > -1 || e.indexOf("Windows Vista") > -1) && (t = "Vista"), (e.indexOf("Windows NT 6.1") > -1 || e.indexOf("Windows 7") > -1) && (t = "7"), (e.indexOf("Windows NT 6.2") > -1 || e.indexOf("Windows 8") > -1) && (t = "8"), (e.indexOf("Windows NT 6.3") > -1 || e.indexOf("Windows 8.1") > -1) && (t = "8.1"), (e.indexOf("Windows NT 10") > -1 || e.indexOf("Windows 10") > -1) && (t = "10"), t
  }, s = function (e) {
    ...
    var e = {}, t = {}, n = navigator.userAgent, r = navigator.platform, i = n.match(/Web[kK]it[\/]{0,1}([\d.]+)/),
      u = n.match(/(Android);?[\s\/]+([\d.]+)?/), c = !!n.match(/\(Macintosh\; Intel /),
      f = n.match(/(iPad).*OS\s([\d_]+)/), l = n.match(/(iPod)(.*OS\s([\d_]+))?/),
      h = !f && n.match(/(iPhone\sOS)\s([\d_]+)/), d = n.match(/(webOS|hpwOS)[\s\/]([\d.]+)/),
      p = /Win\d{2}|Windows/.test(r), g = n.match(/Windows Phone ([\d.]+)/), y = d && n.match(/TouchPad/),
      v = n.match(/Kindle\/([\d.]+)/), _ = n.match(/Silk\/([\d._]+)/), m = n.match(/(BlackBerry).*Version\/([\d.]+)/),
      w = n.match(/(BB10).*Version\/([\d.]+)/), T = n.match(/(RIM\sTablet\sOS)\s([\d.]+)/), A = n.match(/PlayBook/),
      b = n.match(/Chrome\/([\d.]+)/) || n.match(/CriOS\/([\d.]+)/), S = n.match(/Firefox\/([\d.]+)/),
      E = n.match(/\((?:Mobile|Tablet); rv:([\d.]+)\).*Firefox\/[\d.]+/),
      I = n.match(/MSIE\s([\d.]+)/) || n.match(/Trident\/[\d](?=[^\?]+).*rv:([0-9.].)/),
      k = !b && n.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/),
    ...
    return e.tablet = !!(f || A || u && !n.match(/Mobile/) || S && n.match(/Tablet/) || I && !n.match(/Phone/) && n.match(/Touch/)), e.phone = !(e.tablet || e.ipod || !(u || h || d || m || w || b && n.match(/Android/) || b && n.match(/CriOS\/([\d.]+)/) || S && n.match(/Mobile/) || I && n.match(/Touch/))), e.pc = !e.tablet && !e.phone, c ? e.name = "macOS" : p ? (e.name = "windows", e.version = a()) : e.name = o(e), t.name = s(t), {
      os: e,
      browser: t
    }
  }(), c = function () {
    ...
    return i(e, null, [{
      key: "getHost", value: function (e) {
        ...
        var t = r, i = r.split("/");
        return i && i.length > 0 && (t = i[0]), i = t.split(":"), i && i.length > 0 && (t = i[0]), t
      }
    }, {
      key: "os", get: function () {
        return u.os
      ...
      key: "browser", get: function () {
        var e = u.browser;
        return e.name || (e.name = this.getBrowserType()), e
      }
    }]), e
  }();
  t.default = c
  ...
  }(), a = n(22), s = r(a), u = n(23), c = r(u), f = function () {
    function e() {
      i(this, e)
    }

    return o(e, null, [{
      key: "refreshUploadAuth", value: function (e, t, n) {
        var r = (c.default.randomUUID(), c.default.randomUUID()), i = {
            AccessKeyId: e.accessKeyId,
          ...
          o = c.default.makeUTF8sort(i, "=", "&") + "&Signature=" + c.default.aliyunEncodeURI(c.default.makeChangeSiga(i, e.accessKeySecret)),
          a = "https://vod.cn-shanghai.aliyuncs.com/?" + o;
        s.default.get(a, function (e) {
          var e = JSON.parse(e);
          t && t(e)
        }, function (e) {
          if (n) {
      ...
      key: "getUploadAuth", value: function (e, t, n) {
        var r = (c.default.randomUUID(), c.default.randomUUID()), i = {
          AccessKeyId: e.accessKeyId,
          SecurityToken: e.securityToken,
        ...
        e.fileSize && (i.FileSize = e.fileSize), e.description && (i.Description = e.description), e.cateId && (i.CateId = e.cateId), e.tags && (i.Tags = e.tags), e.templateGroupId && (i.TemplateGroupId = e.templateGroupId);
        var o = c.default.makeUTF8sort(i, "=", "&") + "&Signature=" + c.default.aliyunEncodeURI(c.default.makeChangeSiga(i, e.accessKeySecret)),
          a = "https://vod.cn-shanghai.aliyuncs.com/?" + o;
        s.default.get(a, function (e) {
          var e = JSON.parse(e);
          t && t(e)
      ...
      key: "getImageUploadAuth", value: function (e, t, n) {
        var r = (c.default.randomUUID(), c.default.randomUUID()), i = {
          AccessKeyId: e.accessKeyId,
          SecurityToken: e.securityToken,
        ...
        e.title && (i.Title = e.title), e.imageExt && (i.ImageExt = e.imageExt), e.tags && (i.Tags = e.tags);
        var o = c.default.makeUTF8sort(i, "=", "&") + "&Signature=" + c.default.aliyunEncodeURI(c.default.makeChangeSiga(i, e.accessKeySecret)),
          a = "https://vod.cn-shanghai.aliyuncs.com/?" + o;
        s.default.get(a, function (e) {
          var e = JSON.parse(e);
  ...
  var i = function () {
    ...
    return i(e, null, [{
      key: "get", value: function (e, t, n, r, i) {
        var o;
        n = n || function () {
        ...
        }), o = new XMLHttpRequest, o.onreadystatechange = function () {
          4 === o.readyState && (200 === o.status ? t(o.responseText) : n(o.responseText))
        };
        try {
          void 0 === r && (r = !0), o.open("GET", e, r), i && (o.withCredentials = !0)
        } catch (e) {
          return void n(e)
        }
        try {
  ...
  }(), o = n(24), a = n(27), s = (n(28), function () {
    function e() {
      r(this, e)
    }

    return i(e, null, [{
      key: "randomUUID", value: function () {
      ...
      key: "makeUTF8sort", value: function (t, n, r) {
        ...
        for (var a = i.sort(), s = "", u = a.length, o = 0; o < u; o++) {
          var c = e.aliyunEncodeURI(a[o]), f = e.aliyunEncodeURI(t[a[o]]);
          "" == s ? s = c + n + f : s += r + c + n + f
        }
        return s
      }
    }, {
      key: "makeChangeSiga", value: function (t, n) {
        if (!t) throw new Error("PrismPlayer Error: vid should not be null!");
        return a.stringify(o("GET&" + e.aliyunEncodeURI("/") + "&" + e.aliyunEncodeURI(e.makeUTF8sort(t, "=", "&")), n + "&"))
      }
    }]), e
  }());
  t.default = s
  ...
  !function (r, i) {
    ...
    return function () {
      ...
      var n = e, r = n.lib, i = r.WordArray, o = n.enc;
      o.Base64 = {
        stringify: function (e) {
          var t = e.words, n = e.sigBytes, r = this._map;
          e.clamp();
          for (var i = [], o = 0; o < n; o += 3) for (var a = t[o >>> 2] >>> 24 - o % 4 * 8 & 255, s = t[o + 1 >>> 2] >>> 24 - (o + 1) % 4 * 8 & 255, u = t[o + 2 >>> 2] >>> 24 - (o + 2) % 4 * 8 & 255, c = a << 16 | s << 8 | u, f = 0; f < 4 && o + .75 * f < n; f++) i.push(r.charAt(c >>> 6 * (3 - f) & 63));
          var l = r.charAt(64);
